...
The following code was obtained directly from flutter.dev. I updated the images and text to fit our app.
All Text below if directly from the Flutter team.
